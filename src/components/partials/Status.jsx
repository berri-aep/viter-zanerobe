...
const Status = ({ text }) => {
  return (
    <span
      className={
        text === "Active"
          ? "bg-green-200 text-green-800 text-xs font-medium mr-2 px-2 py-0.3 rounded-full"
          ...
          : "bg-gray-200 bg-opacity-75 text-gray-800 text-xs font-medium mr-2 px-2 py-0.3 rounded-full"
      }
    >
      {text}
    </span>
