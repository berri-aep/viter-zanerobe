      ...
      <div className="container">
        ...
        >
          ...
          <Link
            ...
            className={`  ${
              isOpen ? "!text-black" : ""
            } text-xl uppercase font-bold duration-700`}
          >
            Zanerobe
          </Link>
          ...
          >
            <ul
              className={`flex gap-5 main-nav flex-col md:flex-row translate-x-[50px] md:translate-x-0 translate-y-[50px] md:translate-y-0 w-[75%] md:w-auto`}
            >
              <li>
          ...
          <ul
            className={` ${
              isOpen ? "!text-black" : ""
            }  flex gap-5  group-hover:text-black duration-700`}
          >
