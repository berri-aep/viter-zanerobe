import { Facebook, InstagramIcon, Twitter, YoutubeIcon } from 'lucide-react';
  ...
  return (
    <footer className="pt-20 text-black">
      <div className="container">
        <div className="grid md:grid-cols-[1.5fr,_1fr,_1fr,_0.8fr] gap-5 mb-5">
          <div className="footer-box mb-5 max-w-[400px]">
            <h6>Our Story</h6>
            <p>
          ...
          <div className="footer-box">
            ...
            <ul className="flex gap-5 mt-12 items-end">
              ...
              <li>
                <Link to="/">
                  <YoutubeIcon strokeWidth={1} size={25} />
                </Link>
              </li>
              <li>
                <Link to="/">
                  <InstagramIcon strokeWidth={1} size={25} />
                </Link>
              </li>
            </ul>
          </div>
